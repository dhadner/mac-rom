 ...
 C Interface to the Macintosh Libraries
  ...
  All rights reserved
	...
	Change History (most recent first):
		...
		<37>	 6/14/91	JL		Checked in official MPW 3.2Ä version. Removed the comma after
		...
		<25>	 9/16/90	PKE		In NItl4Rec, rename ÔresHeader1' field to Ôformat', since that
		...
		<10>	 3/21/90	PKE		Rearranged the length fields in NItl4Rec to be correct.
		 ...
		 <6>	  3/2/90	PKE		Removed version number constants: smgrVers (Script Mgr),
									...
									ÔNItl4Rec' to the extended version of Itl4Rec, and

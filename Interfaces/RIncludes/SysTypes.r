/*
	...
	Change History (most recent first):
	   ...
	   <SM2>	 5/17/92	kc		Roll in Horror changes. Comments follow:
		<H3>	 2/12/92	SWC		Added Ôaccl' definition, which describes mouse/trackball
									acceleration curves for new cursor code.
		<H2>	11/12/91	jmp		Added Ôpslt' definition and equates from System Disk 7.0.1.
	...
	7.0 Change History:
		...
		<23>	 9/25/91	PKE		For Cube-E (and Bruges): Add system flags (currently just line
									...
									the SMgrRecord.
		<22>	 7/30/91	PKE		Fix Ôitl1' template by adding 'align word' between tables in
									extended format.
		<21>	  1/3/91	JDR		(dba) Encode field of a snd is missing. It is the upper byte of
									the old baseFrequency INTEGER.
		<20>	12/15/90	PKE		(csd) Add RotateKybd constant for first field of ÔKSWP'.
